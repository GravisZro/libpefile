...
namespace pefile
{
  ...
  {
  public:
    explicit PEFormatError(const std::string& value) : std::runtime_error(value), m_value(value) {}
  ...
  template<typename T>
  T read_packed(std::span<const uint8_t> data, size_t offset = 0)
  {
    T val{};
    if (offset + sizeof(T) > data.size())
    {
      throw PEFormatError("read_packed: out of bounds read (need " + std::to_string(offset + sizeof(T))
  ...
  struct [[gnu::packed]] DosHeader
  {
    ...
    static DosHeader parse(std::span<const uint8_t> data, size_t offset = 0)
    {
      return read_packed<DosHeader>(data, offset);
    }

    std::span<const uint8_t> raw_bytes() const
    {
  ...
  struct [[gnu::packed]] FileHeader
  {
    ...
    static FileHeader parse(std::span<const uint8_t> data, size_t offset)
    {
  ...
  struct DataDirectory : DataDirectoryRaw
  {
    ...
    static DataDirectory parse(std::span<const uint8_t> data, size_t offset)
    {
      DataDirectory dd;
  ...
  struct [[gnu::packed]] OptionalHeader32
  {
    ...
    static OptionalHeader32 parse(std::span<const uint8_t> data, size_t offset)
    {
  ...
  struct [[gnu::packed]] OptionalHeader64
  {
    ...
    static OptionalHeader64 parse(std::span<const uint8_t> data, size_t offset)
    {
  ...
  struct [[gnu::packed]] SectionHeader
  {
    ...
    std::string name() const { return std::string(Name, strnlen(Name, 8)); }

    static SectionHeader parse(std::span<const uint8_t> data, size_t offset)
    {
  ...
  struct [[gnu::packed]] ImageImportDescriptor
  {
    ...
    static ImageImportDescriptor parse(std::span<const uint8_t> data, size_t offset)
    {
    ...
    {
      return OriginalFirstThunk == 0 && TimeDateStamp == 0 && ForwarderChain == 0 && Name == 0
             && FirstThunk == 0;
    }
  };
  ...
  struct [[gnu::packed]] ImageExportDirectory
  {
    ...
    static ImageExportDirectory parse(std::span<const uint8_t> data, size_t offset)
    {
    ...
    bool all_zeroes() const
    {
      return Characteristics == 0 && TimeDateStamp == 0 && Name == 0 && NumberOfFunctions == 0
             && NumberOfNames == 0;
    }
  };
  ...
  struct [[gnu::packed]] ImageResourceDirectoryEntry
  {
    ...
    uint32_t name_id() const { return Name & 0x7FFFFFFF; }
    uint32_t offset() const { return OffsetToData & 0x7FFFFFFF; }

    static ImageResourceDirectoryEntry parse(std::span<const uint8_t> data, size_t offset)
    {
  ...
  struct [[gnu::packed]] ImageResourceDataEntry
  {
    ...
    static ImageResourceDataEntry parse(std::span<const uint8_t> data, size_t offset)
    {
  ...
  struct [[gnu::packed]] ImageThunkData32
  {
    union [[gnu::packed]]
    {
      uint32_t ForwarderString = 0;
      uint32_t Function;
      uint32_t Ordinal;
      uint32_t AddressOfData;
    };

    static ImageThunkData32 parse(std::span<const uint8_t> data, size_t offset)
    {
  ...
  struct [[gnu::packed]] ImageThunkData64
  {
    union [[gnu::packed]]
    {
      uint64_t ForwarderString = 0;
      uint64_t Function;
      uint64_t Ordinal;
      uint64_t AddressOfData;
    };

    static ImageThunkData64 parse(std::span<const uint8_t> data, size_t offset)
    {
  ...
  struct [[gnu::packed]] ImageDebugDirectory
  {
    ...
    static ImageDebugDirectory parse(std::span<const uint8_t> data, size_t offset)
    {
  ...
  struct [[gnu::packed]] ImageBaseRelocation
  {
    ...
    static ImageBaseRelocation parse(std::span<const uint8_t> data, size_t offset)
    {
  ...
  {
    uint32_t StartAddressOfRawData = 0;
    uint32_t EndAddressOfRawData = 0;
    uint32_t AddressOfIndex = 0;
    uint32_t AddressOfCallBacks = 0;
    uint32_t SizeOfZeroFill = 0;
    uint32_t Characteristics = 0;

    static ImageTlsDirectory32 parse(std::span<const uint8_t> data, size_t offset)
    {
  ...
  struct [[gnu::packed]] ImageTlsDirectory64
  {
    ...
    static ImageTlsDirectory64 parse(std::span<const uint8_t> data, size_t offset)
    {
  ...
  struct [[gnu::packed]] RuntimeFunction
  {
    ...
    static RuntimeFunction parse(std::span<const uint8_t> data, size_t offset)
    {
  ...
  struct UnwindInfo : UnwindInfoRaw
  {
    ...
    static UnwindInfo parse(std::span<const uint8_t> data, size_t offset);
  };

  struct [[gnu::packed]] ImageBoundImportDescriptor
  {
    uint32_t TimeDateStamp = 0;
    uint16_t OffsetModuleName = 0;
    uint16_t NumberOfModuleForwarderRefs = 0;

    static ImageBoundImportDescriptor parse(std::span<const uint8_t> data, size_t offset)
    {
  ...
  struct [[gnu::packed]] ImageBoundForwarderRef
  {
    ...
    static ImageBoundForwarderRef parse(std::span<const uint8_t> data, size_t offset)
    {
  ...
  struct [[gnu::packed]] ImageDelayImportDescriptor
  {
    ...
    static ImageDelayImportDescriptor parse(std::span<const uint8_t> data, size_t offset)
    {
      return read_packed<ImageDelayImportDescriptor>(data, offset);
    }

    bool all_zeroes() const { return AllAttributes == 0 && Name == 0 && ModuleHandleRVA == 0; }

    uint32_t pINT() const { return DelayINT; }
    uint32_t pIAT() const { return DelayIAT; }
    uint32_t szName() const { return Name; }
    uint32_t grAttrs() const { return AllAttributes; }
    uint32_t pBoundIAT() const { return BoundDelayImportTable; }
    uint32_t pUnloadIAT() const { return UnloadDelayImportTable; }
  };
